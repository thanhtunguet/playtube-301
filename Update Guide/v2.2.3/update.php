            ...
            <div class="col-md-10">
               <div class="wo_install_wiz">
                 <?php if ($updated == false) { ?>
                  <div>
                     <h2 class="light">Update to v2.2.3 </span></h2>
                     <div class="setting-well">
                        <h4>Changelog</h4>
                        <ul class="wo_update_changelog">
                          <li>[Added] quailty selector to embed video system.</li>
                          <li>[Fixed] videos playing twice in background.</li>
                          <li>[Fixed] ads showing on upload/import page, cause design glitch.</li>
                          <li>[Fixed] shorts title was not updating. </li>
                          <li>[Fixed] youtube video was not embedable.</li>
                          <li>[Fixed] embed player size was not fixed.</li>
                          <li>[Fixed] clicking on channel name in search page takes you to image link instead of channel.</li>
