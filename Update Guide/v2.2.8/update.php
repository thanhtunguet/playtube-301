                  ...
                  <div>
                     ...
                     <div class="setting-well">
                        ...
                        <ul class="wo_update_changelog">
                           <li>[Fixed] emojis not working on comments.</li>
                          <li>[Fixed] embed video issue getting "connection refused".</li>
                          <li>[Fixed] sometimes getting "bad-request" when uploading a new video.</li>
                          <li>[Fixed] uploadDate in videoObject (SEO).</li>
                          <li>[Fixed] date/time in videoObject (SEO).</li>
                          <li>[Fixed] pinned comments not showing when user is not logged in.</li>
                          <li>[Fixed] webp images were not working.</li>
                          <li>[Fixed] Google analytics code not showing in embed page.</li>
                          <li>[Fixed] comments not working on brave/edge browser.</li>
                          <li>[Fixed] clicking load more then clicking on any video will go to 404 page (history page).</li>
                          <li>[Fixed] plyr not working on default theme.</li>
                          <li>[Fixed] changing embed settings in edit video page was hanging.</li>
...
<script>
var queries = [
    "ALTER TABLE `comments` CHANGE `text` `text` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL;",
    "ALTER TABLE `comm_replies` CHANGE `text` `text` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL;",
];
