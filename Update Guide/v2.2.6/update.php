            ...
            <div class="col-md-10">
               <div class="wo_install_wiz">
                 <?php if ($updated == false) { ?>
                  <div>
                     <h2 class="light">Update to v2.2.6 </span></h2>
                     ...
                     <div class="setting-well">
                        ...
                        <ul class="wo_update_changelog">
                          <li>[Added] the ability to upload media files from admin panel directly to spaces, amazon, wasabi and blackaze.</li>
                          <li>[Added] custom endpoint (domain name) for S3, Spaces, Wasabi and Backblaze (CDN support).</li>
                          <li>[Added] chunk upload system, now the video is being chunked while uploading to small parts.</li>
                          <li>[Added] support for lightspeed.</li>
...
var queries = [
    ...
    "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'backblaze_region', '');",
    ...
    "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'chunk_size', '1900KB');"
];
