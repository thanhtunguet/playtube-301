                  ...
                  <div>
                     ...
                     <div class="setting-well">
                        ...
                        <ul class="wo_update_changelog">
                            <li>[Added] the ability to import M3U8 videos.</li>
                            <li>[Added] Qiwi payment method.</li>
                            <li>[Fixed] login and register page not that responsive on mobile.</li>
                            <li>[Fixed] categories not showing on mobile. (default theme)</li>
                            <li>[Fixed] single quotes showing like hashtags, </li>
                            <li>[Fixed] showing {{NOTIFY_BUTTON}} code on profile page if not logged in.</li>
                            <li>[Fixed] ads cannot be created with default theme as the placement is missing. .</li>
                            <li>[Fixed] paypal payment issues.</li>
                            <li>[Improved] speed of all /videos/ pages, like latest, top, trending etc.</li>
                        </ul>
...
<script>
var queries = [
    "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'qiwi_payment', 'no');",
    "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'qiwi_public_key', '');",
    "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'qiwi_private_key', '');",
    "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'm3u8_import', 'off');",
    "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'who_can_m3u8_import', 'all');",
    "INSERT INTO `langs` (`id`, `lang_key`) VALUES (NULL, 'qiwi');",
];
