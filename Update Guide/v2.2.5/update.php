            ...
            <div class="col-md-10">
               <div class="wo_install_wiz">
                 <?php if ($updated == false) { ?>
                  <div>
                     <h2 class="light">Update to v2.2.5 </span></h2>
                     ...
                     <div class="setting-well">
                        ...
                        <ul class="wo_update_changelog">
                          <li>[Added] more regions to spaces and amazon s3.</li>
                          <li>[Fixed] tiktok short links not importing.</li>
                          <li>[Fixed] DigitalOcean, BackBlaze and Wasabi upload system.</li>
